...
namespace Orikivo.Modules
{
    ...
    [DontAutoLoad]
    public class ProfilingModule : ModuleBase<OrikivoCommandContext>
    {
        ...
        public ProfilingModule(DiscordSocketClient client, IConfigurationRoot config, CommandService service)
        {
            _client = client;
            _config = config;
            _service = service;
